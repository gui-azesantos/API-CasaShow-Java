package com.gft.apicasashow.openapi;
...
public class SpringFoxConfig implements WebMvcConfigurer {
	...
	public Docket apiDocket() {
		return new Docket(DocumentationType.SWAGGER_2).
				select().
				apis(RequestHandlerSelectors.basePackage("com.gft.apicasashow.resorces"))
				.build()
				.apiInfo(apiInfo())
				.tags(new Tag("Eventos", "Gerencia os Eventos"), new Tag("Locais", "Gerencia os Locais"));
	}
	
	public ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				.title("Eventos.com API")
